...
class PyBuildExt(build_ext):
    ...
    def detect_readline_curses(self):
        ...
        if do_readline:
            if CROSS_COMPILING:
                ...
                ret = os.system(f"ldd {do_readline} > {tmpfile}")
            else:
                ret = 256
            if ret >> 8 == 0:
                with open(tmpfile) as fp:
    ...
    def detect_dbm_gdbm(self):
        ...
        try:
            ...
            # dependency.
            db_incs = None if db_incdir in self.inc_dirs else [db_incdir]
    ...
    def detect_sqlite(self):
            ...
            if os.path.exists(f):
                ...
                if m := re.search(
                    ...
                    if sqlite_version_tuple >= MIN_SQLITE_VERSION_NUMBER:
                        ...
                        if sqlite_setup_debug:
                            print(
                                f"{d}: version {sqlite_version} is too old, need >= {MIN_SQLITE_VERSION}"
                            )
        ...
        if sqlite_incdir:
            ...
            if sqlite_libfile := self.compiler.find_library_file(
        ...
        if sqlite_incdir and sqlite_libdir:
            ...
            sqlite_extra_link_args = ('-Wl,-search_paths_first', ) if MACOS else ()
    ...
    def detect_multibytecodecs(self):
        ...
        for loc in ('kr', 'jp', 'cn', 'tw', 'hk', 'iso2022'):
            self.add(Extension(f'_codecs_{loc}', [f'cjkcodecs/_codecs_{loc}.c']))
